	...
	AbsListView.MultiChoiceModeListener
{
	...
	Button obd_data,pending_fault,clear_fault;
	public enum MODE
	{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		obd_data=findViewById(R.id.obd_data);
	...
	void faulCodeButtons(){
		...
		obd_data.setOnClickListener(new View.OnClickListener() {
			@Override
		...
		pending_fault.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		clear_fault.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				clearObdFaultCodes();
	...
	public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id)
	{
		...
		switch (CommService.elm.getService())
		{
			...
			case ObdProt.OBD_SVC_PENDINGCODES:
				//do the follwing when you long click the list item
			...
			try
			{
				...
				switch (msg.what)
				{
					...
					case MESSAGE_FILE_READ:
						...
						//reads the current fault codes and sets them to the adapter
...
*/
	...
	{
		//when bluetooth is connected do the following
		stopDemoService();
	...
	//when bluetooth is disconnected do the following
	{
		// handle further initialisations
		setMode(MODE.OFFLINE);
	}
